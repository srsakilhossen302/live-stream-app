...
class HomeScreen extends GetView<HomeController> {
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.add, color: const Color(0xFF0F0B1E), size: 28.sp),
          ),
  ...
  Widget _buildNavItem(IconData icon, bool isSelected) {
    return Icon(
      icon,
      color: isSelected ? const Color(0xFF8B9BFF) : Colors.white38,
      size: 26.sp,
    );
  }
                  ...
                  if (index == 0)
                    Center(
                      child: Container(
                        ...
                        child: Text(
                          "LIVE PREVIEW",
                          style: TextStyle(color: Colors.white, fontSize: 10.sp, fontWeight: FontWeight.w900, letterSpacing: 0.5),
                        ),
                      ),
                    ),
                  Text(
